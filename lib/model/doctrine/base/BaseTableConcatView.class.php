 ...
 * @method TableConcatView setWord1()   Sets the current record's "word1" value
 * @method TableConcatView setNdoc1()   Sets the current record's "ndoc1" value
 * @method TableConcatView setNentry1() Sets the current record's "nentry1" value
 * @method TableConcatView setIsSpam()  Sets the current record's "is_spam" value
 * 
 * @package    gepfilter
 * @subpackage model
 ...
 */
abstract class BaseTableConcatView extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('table_concat_view');
